    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmailQueueUser", x => new { x.EmailQueueId, x.UserId });
                    table.ForeignKey(
                        name: "FK_EmailQueueUser_EmailQueues_EmailQueueId",
                        column: x => x.EmailQueueId,
                        principalTable: "EmailQueues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmailQueueUser_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailQueueUser_UserId",
                table: "EmailQueueUser",
                column: "UserId");
